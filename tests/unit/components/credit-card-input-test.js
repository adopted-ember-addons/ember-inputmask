...
test('values are correct', function(assert) {
  ...
  andThen(function() { // wait for async helpers to complete
    assert.equal(find('input').val(), "4444-4444-4444-4444");
    assert.equal(component.get('unmaskedValue'), "4444444444444444");
  });
  ...
  triggerEvent('input', 'blur');
  andThen(function() {
    assert.equal(find('input').val(), "5444-4444-4444-4444");
  ...
  triggerEvent('input', 'blur');
  andThen(function() {
    assert.equal(find('input').val(), "6011-4444-4444-4444");
    assert.equal(component.get('unmaskedValue'), "6011444444444444");
  });
  ...
  triggerEvent('input', 'blur');
  andThen(function() {
    assert.equal(find('input').val(), "2131-4444-4444-4444");
    assert.equal(component.get('unmaskedValue'), "2131444444444444");
  });
  ...
  triggerEvent('input', 'blur');
  andThen(function() {
    assert.equal(find('input').val(), "9444-4444-4444-4444");
  ...
  triggerEvent('input', 'blur');
  andThen(function() {
    assert.equal(find('input').val(), "3054-444444-4444");
    assert.equal(component.get('unmaskedValue'), "30544444444444");
  });
});
